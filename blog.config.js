...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'KebenSun', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '代码编织者，两轮探险家，电子战场老司机。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.kebensun.com', // 网站地址
